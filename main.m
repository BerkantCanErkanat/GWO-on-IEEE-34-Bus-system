...
Function_name='MyFun'; % Name of the test function that can be from F1 to F23 (Table 1,2,3 in the paper)
...
% box on
% legend('GWO')
son_cozum = run34(Best_pos,4444);
pv_cozum = run34(Best_pos,5555);
